...
struct src_range
combine_ranges(struct src_range rng1, struct src_range rng2) {
    if (rng1.f != rng2.f) {
...
void *
vec_push(struct vec *vec, void *val, size_t bytes) {
...
void *
vec_index(struct vec *vec, size_t idx, size_t bytes) {
